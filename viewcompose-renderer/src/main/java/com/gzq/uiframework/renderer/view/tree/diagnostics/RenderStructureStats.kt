...
data class RenderStructureStats(
    ...
    companion object {
        fun from(
            nodes: List<com.gzq.uiframework.renderer.node.VNode>,
...
private fun com.gzq.uiframework.renderer.node.VNode.deepNodeCount(): Int {
    return 1 + children.sumOf { it.deepNodeCount() }
}

private fun com.gzq.uiframework.renderer.node.VNode.deepDepth(): Int {
